        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Sifra = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Naziv = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    mestoTroskaId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_NosiociTroska", x => x.id);
                    table.ForeignKey(
                        name: "FK_NosiociTroska_MestaTroska_mestoTroskaId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NosiociTroska_mestoTroskaId",
                table: "NosiociTroska",
