...
namespace MivexBlagajna.DataAccess
{
    public class MivexBlagajnaDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //    new Komitent { Id = 2, Sifra = 2, Naziv = null, Ime = "Milos", Prezime = "Acimovic", PostanskiBroj = "32205", Mesto = "Trbusani", Adresa = "Trbusani bb", Telefon = "064/040-8769", PravnoLice = false, FizickoLice = true },
            //    new Komitent { Id = 3, Sifra = 3, Naziv = null, Ime = "Ivan", Prezime = "Cvorovic", PostanskiBroj = "32000", Mesto = "Cacak", Adresa = "Bulevar Oslobodilaca Cacka 105b", Telefon = "064/828-1500", PravnoLice = false, FizickoLice = true },
